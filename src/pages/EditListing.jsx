...
import { addDoc, getDoc, serverTimestamp, doc, updateDoc } from "firebase/firestore";
  ...
  const onSubmit = async (e) => {
    ...
    if (geolocationEnabled) {
      const response = await fetch(
        `http://api.positionstack.com/v1/forward?access_key=${process.env.REACT_APP_GEO_API}&query=${address}`
      );
    ...
    const imgUrls = await Promise.all(
      ...
      setLoading(false);
      toast.error("Image not uoploaded");
      return;
    });
